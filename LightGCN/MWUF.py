...
from MWUF_model import LightGCN
...
class Trainer(object):
    def __init__(self, data_config, n_users, n_items, graph):
        ...
        self.model = LightGCN(self.n_users, self.n_items, self.emb_dim, args.layers, self.graph, self.image_feats, self.text_feats)
    ...
    def test(self, users_to_test, users_to_test_cold, users_to_test_warm, photo_one_hop, is_val):
        self.model.eval()
        with torch.no_grad():
            users_emb, items_emb = self.model(photo_one_hop)
    ...
    def train(self):
        ...
        for epoch in range(args.epoch):
            ...
            for idx in tqdm(range(n_batch)):
                ...
                all_users, all_items = self.model(photo_one_hop)

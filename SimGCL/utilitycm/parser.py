...
def parse_args():
    ...
    #train
    parser.add_argument('--data_path', nargs='?', default='/home/shiqifan/rq_vae/STB/datasets/', help='Input data path.')
    parser.add_argument('--seed', type=int, default=2022, help='Random seed')
    parser.add_argument('--dataset', nargs='?', default='', help='Choose a dataset from {sports, baby, clothing, tiktok, allrecipes}')
    parser.add_argument('--epoch', type=int, default=100, help='Number of epoch.')  #default: 1000

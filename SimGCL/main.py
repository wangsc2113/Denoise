...
class Trainer(object):
    ...
    def train(self):
        ...
        for epoch in range(args.epoch):
            t1 = time()
            loss, bpr_loss, reg_loss, re_loss, cl_loss = 0., 0., 0., 0., 0.
            ...
            for idx in tqdm(range(n_batch)):
                ...
                batch_loss = batch_bpr_loss + 0.001 * batch_re_loss + batch_cl_loss + batch_reg_loss
            ...
            if (epoch + 1) % args.verbose != 0:
                perf_str = 'Epoch %d [%.1fs]: train==[%.5f=%.5f + %.5f + %.5f + %.5f]' % (
                    epoch, time() - t1, loss, bpr_loss, cl_loss, re_loss, reg_loss)
...
if __name__ == '__main__':
    ...
    with open('/home/wangshicheng/label_denoising/Dataset/' + args.dataset + '/vv_count.pkl', 'rb') as file:
        vv_count = pickle.load(file)
    with open('/home/wangshicheng/label_denoising/Dataset/' + args.dataset + '/confidence_score.pkl', 'rb') as file:
        confidence_score = pickle.load(file)
    with open('/home/wangshicheng/label_denoising/Dataset/' + args.dataset + '/warm_adj.pkl', 'rb') as file:
